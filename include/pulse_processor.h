...
class PulseProcessor: public WorkerNode, public Consumer<Pulse>, public Producer<SensorAnglesFrame>, public Producer<OOTXFrameBit> {
  public:
  ...
  private:
    ...
    Vector<Pulse, max_num_inputs> cycle_sync_pulses_;
    Vector<Pulse, max_num_inputs*2> cycle_sweep_pulses_;
    Vector<Pulse, max_num_inputs*2> unclassified_sync_pulses_;
